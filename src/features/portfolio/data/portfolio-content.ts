...
export const siteConfig: SiteConfig = {
  ...
  repoAllowlist: [
    ...
    "https://github.com/JshMarkCastillo-GHdev/sys-centry-ticketing",
  ],
};
...
export const skillGroups: SkillGroup[] = [
...

  {
    ...
    items: ["Vercel", "Render", "Hostinger", "Docker", "Google Cloud Platform"],
  },
...
export const featuredProjects: ProjectItem[] = [
...

  {
    ...
    coverImageSrc: `/assets/projects/${projectAssetFolders.centry}/cover.png`,

    screenshotImageSrcs: [
      `/assets/projects/${projectAssetFolders.centry}/screen-01.png`,

      `/assets/projects/${projectAssetFolders.centry}/screen-02.png`,
    ],

    screenshotPlaceholder: {
      label: "Screenshots",

      caption: `Recommended directory: /assets/projects/${projectAssetFolders.centry}/ (16:10, 1600x1000 preferred)`,
    },

    repoUrl: "https://github.com/JshMarkCastillo-GHdev/sys-centry-ticketing",

    liveUrl: "https://sys-centry-ticketing.vercel.app/",

    imageHint: "[ Replace with real info: Screenshot style hint ]",

    featured: false,

    githubRepo: "sys-centry-ticketing",

    highlights: [
      "Role-based ticketing flow: create draft → submit → claim → update status → close, with soft-delete limited to draft tickets.",

      "NextAuth.js credentials auth with JWT sessions and a five-tier role hierarchy enforced in middleware and API routes.",

      "Activity timeline on ticket detail—every create, submit, claim, update, and delete writes to the Activity table.",

      "Docker Compose stack with app, PostgreSQL, and Redis for local development or GCP VM portfolio demos.",
    ],
  },
];
